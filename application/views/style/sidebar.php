<div class="bg-white shadow-lg inline-flex items-center py-2 w-full sm:hidden text-center gap-5">
   ...
   <a href="<?= base_url('admin') ?>" class="text-3xl font-bold text-primary justify-center">
      <h1><b>L'Binusa</b></h1>
   </a>
</div>
...
<aside id="cta-button-sidebar" class="fixed shadow-lg top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full  pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <div class="text-center my-4">
         <a href="<?= base_url('admin') ?>" class=" text-2xl font-bold text-primary">
            <h1><b>L'Binusa</b></h1>
         </a>
      </div>
      ...
      <div class="bottom-5 absolute w-full px-5">
         <div class="flex justify-between">
            <a href="<?= base_url('admin/profile') ?>" class="flex items-center text-gray-900 rounded-lg dark:text-white group">
